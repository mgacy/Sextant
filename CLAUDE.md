...
Tests use `.swift` fixture files in `Tests/SextantTests/Fixtures/` loaded via `Bundle.module`. Test suites: `FileParserTests`, `StructuralQueryTests`, `SymbolTableTests`, `ReferenceFinderTests`.
